...
https://www.codewars.com/kata/62a933d6d6deb7001093de16/javascript
...
function getTheVowels(word) {
    let vowsArr = word.match(/[aeiou]/g);
    let count = 0;
    let lastLetter;
    vowsArr.forEach(e => {
        if (e == 'a' && count == 0) {
        ...
        if (e == 'a' && lastLetter == 'u') {
            count++;
            lastLetter = 'a';
        } else if (e == 'e' && lastLetter == 'a') {
            count++;
            lastLetter = 'e';
        } else if (e == 'i' && lastLetter == 'e') {
            count++;
            lastLetter = 'i';
        } else if (e == 'o' && lastLetter == 'i') {
            count++;
            lastLetter = 'o';
        } else if (e == 'u' && lastLetter == 'o') {
            count++;
            lastLetter = 'u';
        }
    })
