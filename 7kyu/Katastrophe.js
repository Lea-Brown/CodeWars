...
https://www.codewars.com/kata/55a3cb91d1c9ecaa2900001b/javascript
...
function strongEnough(earthquake, age) {
  let count = 1;
  earthquake.forEach(e => {
    count *= e.reduce((a, b) => a + b);
  });

  let building = 1000;
  for (let i = 0; i < age; i++) {
    building = (building / 100) * (100 - 1);
  }

  return count <= building ? 'Safe!' : 'Needs Reinforcement!';
}
