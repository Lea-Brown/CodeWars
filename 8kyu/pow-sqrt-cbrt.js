...
https://www.codewars.com/kata/5733f948d780e27df6000e33/javascript
...
function cutCube(volume, n) {
  const isPerfectCube = volume => Math.cbrt(volume) % 1 === 0;
  return isPerfectCube(volume) && isPerfectCube(n) && volume % n === 0;
}
